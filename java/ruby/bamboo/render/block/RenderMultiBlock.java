...
public class RenderMultiBlock implements IRenderBlocks {
    ...
    public void renderBlock(RenderBlocks renderblocks, Block par1Block, int par2, int par3, int par4) {
        ...
        if (tile instanceof TileEntityMultiBlock) {
            ...
            if (!((TileEntityMultiBlock) tile).isEmpty()) {
                float size = (1 / (float) tileMulti.getFieldSize());
                ...
                renderTop(renderblocks, par1Block, par2, par3, par4);
            }
        }
    }

    private void renderMultiBlock(RenderBlocks renderblocks, BlockMultiBlock par1Block, byte visibleFlg, float size, int par2, int par3, int par4, byte innerX, byte innerY, byte innerZ) {
    ...
    private void renderTop(RenderBlocks render, Block block, int x, int y, int z) {
