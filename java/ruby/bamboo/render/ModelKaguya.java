...
* //variables init: public ModelRenderer box; public ModelRenderer box0;
* public ModelRenderer box1; public ModelRenderer box10; public ModelRenderer
* box2; public ModelRenderer box3; public ModelRenderer box4; public
* ModelRenderer box5; public ModelRenderer box6; public ModelRenderer box7;
* public ModelRenderer box8; public ModelRenderer box9;
* 
* //constructor: box = new ModelRenderer(32, 13); box.addBox(-3F, -3F, -3F, 6,
* 6, 6); box.setPosition(0F, 2F, 0F); box.rotateAngleZ = (float)Math.PI;
* 
* box0 = new ModelRenderer(32, 0); box0.addBox(-3F, -11F, -3F, 6, 7, 6);
* box0.rotateAngleZ = (float)Math.PI;
* 
* box1 = new ModelRenderer(0, 0); box1.addBox(-4F, -6F, -4F, 8, 7, 8);
* box1.setPosition(0F, 12F, 0F); box1.rotateAngleZ = (float)Math.PI;
* 
* box10 = new ModelRenderer(55, 13); box10.addBox(1F, -4F, -8F, 2, 2, 2);
* box10.setPosition(6F, 6F, -1F); box10.rotateAngleX = 0.24434609527920614F;
* box10.rotateAngleY = 5.846852994181004F; box10.rotateAngleZ =
* 2.9670597283903604F;
* 
* box2 = new ModelRenderer(0, 17); box2.addBox(1F, -4F, -7F, 2, 7, 8);
* box2.setPosition(6F, 6F, -1F); box2.rotateAngleX = 0.24434609527920614F;
* box2.rotateAngleY = 5.846852994181004F; box2.rotateAngleZ =
* 2.9670597283903604F;
* 
* box3 = new ModelRenderer(0, 17); box3.addBox(-3F, -4F, -7F, 2, 7, 8);
* box3.setPosition(-6F, 6F, -1F); box3.rotateAngleX = 0.24434609527920614F;
* box3.rotateAngleY = 0.4363323129985824F; box3.rotateAngleZ =
* 3.3161255787892263F;
* 
* box4 = new ModelRenderer(12, 15); box4.addBox(-4F, 1F, 4F, 8, 8, 1);
* box4.setPosition(0F, 12F, -1F); box4.rotateAngleZ = (float)Math.PI;
* 
* box5 = new ModelRenderer(0, 0); box5.addBox(-4F, -2F, -5F, 1, 2, 2);
* box5.setPosition(0F, 12F, 1F);
* 
* box6 = new ModelRenderer(0, 0); box6.addBox(3F, -2F, -4F, 1, 2, 2);
* box6.setPosition(0F, 12F, 0F);
* 
* box7 = new ModelRenderer(56, 1); box7.addBox(3F, 0F, 2F, 1, 9, 3);
* box7.setPosition(0F, 12F, -1F); box7.rotateAngleZ = (float)Math.PI;
* 
* box8 = new ModelRenderer(56, 1); box8.addBox(-4F, 0F, 2F, 1, 9, 3);
* box8.setPosition(0F, 12F, -1F); box8.rotateAngleZ = (float)Math.PI;
* 
* box9 = new ModelRenderer(55, 13); box9.addBox(-3F, -4F, -8F, 2, 2, 2);
* box9.setPosition(-6F, 6F, -1F); box9.rotateAngleX = 0.24434609527920614F;
* box9.rotateAngleY = 0.4363323129985824F; box9.rotateAngleZ =
* 3.3161255787892263F;
* 
* //render: box.render(f5); box0.render(f5); box1.render(f5);
* box10.render(f5); box2.render(f5); box3.render(f5); box4.render(f5);
* box5.render(f5); box6.render(f5); box7.render(f5); box8.render(f5);
* box9.render(f5);
*/
