...
public class BambooEnchantment {
    public static HashMap<Integer, EnchantBase> idToEnchantMap = new HashMap<Integer, EnchantBase>();
    ...
    public static final EnchantBase power = new EnchantPower(3, "power ", 3, 1F, 1F);
