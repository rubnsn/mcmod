...
public class IFF {
        ...
        if (pEntity instanceof EntityLivingBase) {
            if (pEntity instanceof EntityLittleMaidBase) {
                ...
                case 1:
                    ...
                    ((EntityLittleMaidBase) pEntity).setContract(true);
            ...
            if (pMap != null) {
                ...
                littleMaidMob.Debug(pName + " added.");
            }
    ...
    public static int getIFF(String pUsername, String entityname) {
        if (entityname == null) {
            return littleMaidMob.cfg_Aggressive ? iff_Enemy : iff_Friendry;
        }
        int lt = iff_Enemy;
        Map<String, Integer> lmap = getUserIFF(pUsername);
    ...
    public static int getIFF(String pUsername, Entity entity) {
        ...
        int li = 0;
        if (entity instanceof EntityLittleMaidBase) {
            if (((EntityLittleMaidBase) entity).isContract()) {
                if (((EntityLittleMaidBase) entity).getOwnerName().contentEquals(pUsername)) {
                    // 自分の
            ...
            String loname = ((EntityTameable) entity).func_152113_b();//getOwnerName();
            if (!loname.isEmpty()) {
    ...
    protected static File getFile(String pUsername) {
        ...
        littleMaidMob.Debug(lfile.getAbsolutePath());
        return lfile;
    }
        ...
        try {
            if ((lfile.exists() || lfile.createNewFile()) && lfile.canWrite()) {
                ...
                for (Entry<Integer, List<Item>> le : TriggerSelect.getUserTrigger(pUsername).entrySet()) {
                    ...
                    sb.append("triggerWeapon").append(TriggerSelect.selector.get(le.getKey())).append("=");
