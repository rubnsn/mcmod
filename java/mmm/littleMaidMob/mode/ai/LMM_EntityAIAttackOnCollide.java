...
public class LMM_EntityAIAttackOnCollide extends EntityAIBase implements
        LMM_IEntityAI {
    ...
    public LMM_EntityAIAttackOnCollide(EntityLittleMaidBase par1EntityLittleMaid, float par2, boolean par3) {
    ...
    public void startExecuting() {
        ...
        rerouteTimer = 0;
        theMaid.playSound(theMaid.isBloodsuck() ? EnumSound.findTarget_B : EnumSound.findTarget_N, false);
    ...
    public void updateTask() {
        ...
        if (theMaid.avatar.isUsingItem() && !lguard) {
            theMaid.avatar.stopUsingItem();
        }
