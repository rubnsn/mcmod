...
public class EntityBulletBase extends Entity implements IProjectile,
    ...
    public void onUpdate() {
        ...
        Vec3 lvt = Vec3.createVectorHelper(posX + motionX, posY + motionY, posZ + motionZ);
        while (true) {
            // Block用
            ...
            if (movingobjectposition != null) {
                lvt = Vec3.createVectorHelper(movingobjectposition.hitVec.xCoord, movingobjectposition.hitVec.yCoord, movingobjectposition.hitVec.zCoord);
            }
            ...
            if (!worldObj.isRemote) {
                ...
                for (int j = 0; j < list.size(); ++j) {
                    ...
                    if (entity1.canBeCollidedWith() && (entity1 != entitylivingbase || this.ticksInAir >= 5)) {
                        ...
                        MovingObjectPosition movingobjectposition1 = axisalignedbb.calculateIntercept(lvo, lvt);
    ...
    protected boolean onImpact(MovingObjectPosition var1) {
        if (var1.entityHit != null) {
            if (bullet != null) {
                ...
                var1.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, getThrower()), 1.0F);
                if (!worldObj.isRemote) {
                    setDead();
                }
                return true;
            ...
            if (checkDestroyBlock(var1, var1.blockX, var1.blockY, var1.blockZ, lblock, lmeta)) {
                ...
                for (int i = 0; i < 8; ++i) {
                    ...
                    worldObj.spawnParticle("smoke", var1.hitVec.xCoord, var1.hitVec.yCoord, var1.hitVec.zCoord, 0.0D, 0.0D, 0.0D);
                }
                return true;
            }
        }
    ...
    public boolean checkDestroyBlock(MovingObjectPosition var1, int pX, int pY, int pZ, Block pBlock, int pMetadata) {
        if ((pBlock instanceof BlockPane && pBlock.getMaterial() == Material.glass) || (pBlock instanceof BlockFlowerPot) || (pBlock instanceof BlockTNT)) {
            return true;
        }
        return false;
    }
