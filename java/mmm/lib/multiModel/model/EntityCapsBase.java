...
public class EntityCapsBase implements
        mmm.lib.multiModel.model.mc162.IModelCaps {
    ...
    public Object getCapsValue(int pIndex, Object... pArg) {
        ...
        case caps_PosBlock:
            return owner.worldObj.getBlock(MathHelper.floor_double(owner.posX + (Double) pArg[0]), MathHelper.floor_double(owner.posY + (Double) pArg[1]), MathHelper.floor_double(owner.posZ + (Double) pArg[2]));
        case caps_PosBlockID:
            return Block.getIdFromBlock(owner.worldObj.getBlock(MathHelper.floor_double(owner.posX + (Double) pArg[0]), MathHelper.floor_double(owner.posY + (Double) pArg[1]), MathHelper.floor_double(owner.posZ + (Double) pArg[2])));
        case caps_PosBlockMeta:
            return owner.worldObj.getBlockMetadata(MathHelper.floor_double(owner.posX + (Double) pArg[0]), MathHelper.floor_double(owner.posY + (Double) pArg[1]), MathHelper.floor_double(owner.posZ + (Double) pArg[2]));
        case caps_PosBlockAir:
            return owner.worldObj.isAirBlock(MathHelper.floor_double(owner.posX + (Double) pArg[0]), MathHelper.floor_double(owner.posY + (Double) pArg[1]), MathHelper.floor_double(owner.posZ + (Double) pArg[2]));
        case caps_PosBlockLight:
            return owner.worldObj.getBlockLightValue(MathHelper.floor_double(owner.posX + (Double) pArg[0]), MathHelper.floor_double(owner.posY + (Double) pArg[1]), MathHelper.floor_double(owner.posZ + (Double) pArg[2]));
        case caps_PosBlockPower:
            return owner.worldObj.getBlockPowerInput(MathHelper.floor_double(owner.posX + (Double) pArg[0]), MathHelper.floor_double(owner.posY + (Double) pArg[1]), MathHelper.floor_double(owner.posZ + (Double) pArg[2]));
