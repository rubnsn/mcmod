...
import static mmm.lib.multiModel.model.IModelCaps.caps_Actions;
import static mmm.lib.multiModel.model.IModelCaps.caps_Entity;
import static mmm.lib.multiModel.model.IModelCaps.caps_HeadMount;
import static mmm.lib.multiModel.model.IModelCaps.caps_Items;
    ...
    protected void renderItems(EntityLivingBase pEntityLiving, Render pRender, boolean pRealBlock, EnumAction pAction) {
        ...
        if (adjust) {
            ...
            if (pRealBlock && (litem instanceof ItemBlock)) {
                ...
                float var6;
                if ((litem instanceof ItemBlock) && RenderBlocks.renderItemIn3d(Block.getBlockFromItem(litem).getRenderType())) {
                    var6 = 0.5F;
        ...
        if (pRealBlock && litem instanceof ItemSkull) {
            ...
            if (itemstack.hasTagCompound()) {
                ...
                } else if (itemstack.getTagCompound().hasKey("SkullOwner", 8) && !StringUtils.isNullOrEmpty(itemstack.getTagCompound().getString("SkullOwner"))) {
                    gameprofile = new GameProfile((UUID) null, itemstack.getTagCompound().getString("SkullOwner"));
                }
            }
