...
public class RenderManeki extends TileEntitySpecialRenderer
{
    ...
    private void doRender(TileEntityManeki entity, double d, double d1,
                          double d2, float f, float g)
    {
        GL11.glPushMatrix();
        ...
        int j = MathHelper.floor_double(d1 + (double)(f1 / 16F));
        int k = MathHelper.floor_double(d2);
        int l = entity.worldObj.getLightBrightnessForSkyBlocks(i, j, k, 0);
        int i1 = l % 0x10000;
        int j1 = l / 0x10000;
