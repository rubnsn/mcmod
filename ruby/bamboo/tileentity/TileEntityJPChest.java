...
public class TileEntityJPChest extends TileEntity implements IInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (field_35156_h > 0 && field_35148_f == 0.0F && adjacentChestZNeg == null
                && adjacentChestXNeg == null)
        {
            ...
            worldObj.playSoundEffect(d, yCoord + 0.5D, d2,
                                     "tile.piston.out", 0.4F,
                                     worldObj.rand.nextFloat() * 0.1F + 0.9F);
        }

        if (field_35156_h == 0 && field_35148_f > 0.0F || field_35156_h > 0
                && field_35148_f < 1.0F)
        {
            if (field_35156_h > 0)
            {
            ...
            if (field_35148_f < 0.0F)
            {
                ...
                if (adjacentChestZNeg == null && adjacentChestXNeg == null)
                {
                    ...
                    worldObj.playSoundEffect(d1, yCoord + 0.5D, d3,
                                             "tile.piston.in", 0.5F,
                                             worldObj.rand.nextFloat() * 0.1F + 0.9F);
                }
            }
